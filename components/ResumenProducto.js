  ...
  return (
    (<div className="shadow p-5 mb-3 flex gap-10 items-center">
      ...
      <div className="md:w-4/6">
        ...
        <p className="text-xl front-bold mt-2 text-amber-500">
      ...
      <div>
        ...
        <button
          className="bg-red-700 flex gap-2 px-5 py-2 text-white text-center rounded-md font-bold uppercase shadow-md w-full mt-5"
          type="button"
